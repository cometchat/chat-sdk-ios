...
Pod::Spec.new do |spec|
  ...
  spec.source          = { :http => 'https://library.cometchat.io/ios/v2.0/xcode12/CometChatPro_3_0_0-beta1_2.zip'}
  spec.library          = 'z', 'sqlite3', 'xml2.2'
  spec.xcconfig         = {'HEADER_SEARCH_PATHS' => '$(SDKROOT)/usr/include/libxml2'}
  spec.vendored_frameworks = 'CometChatPro.xcframework','Starscream.xcframework'
