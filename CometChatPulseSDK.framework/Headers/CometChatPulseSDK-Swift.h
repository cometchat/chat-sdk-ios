...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="CometChatPulseSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC17CometChatPulseSDK11BaseMessage")
...
@property (nonatomic, copy) NSString * _Nonnull reciverUid;
@property (nonatomic) enum messageType messageType;
@property (nonatomic) enum receiverType reciverType;
...
SWIFT_CLASS("_TtC17CometChatPulseSDK13ActionMessage")
@interface ActionMessage : BaseMessage
- (nonnull instancetype)initWithReceiverUid:(NSString * _Nonnull)receiverUid messageType:(enum messageType)messageType receiverType:(enum receiverType)receiverType OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC17CometChatPulseSDK9AppEntity")
...
SWIFT_PROTOCOL("_TtP17CometChatPulseSDK11CustomError_")
...
SWIFT_CLASS("_TtC17CometChatPulseSDK11CCException")
...
SWIFT_CLASS("_TtC17CometChatPulseSDK18CometChatConstants")
...
SWIFT_CLASS("_TtC17CometChatPulseSDK4User")
...
SWIFT_CLASS("_TtC17CometChatPulseSDK11CurrentUser")
...
SWIFT_CLASS("_TtC17CometChatPulseSDK5Group")
...
SWIFT_CLASS("_TtC17CometChatPulseSDK11GroupMember")
...
SWIFT_CLASS("_TtC17CometChatPulseSDK19GroupMembersRequest")
...
SWIFT_CLASS("_TtCC17CometChatPulseSDK19GroupMembersRequest26GroupMembersRequestBuilder")
...
SWIFT_CLASS("_TtC17CometChatPulseSDK20GroupMessagesRequest")
...
SWIFT_CLASS("_TtCC17CometChatPulseSDK20GroupMessagesRequest27GroupMessagesRequestBuilder")
@interface GroupMessagesRequestBuilder : NSObject
- (nonnull instancetype)initWithGuid:(NSString * _Nonnull)guid timestamp:(NSInteger)timestamp OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithGuid:(NSString * _Nonnull)guid id:(NSInteger)id OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS("_TtC17CometChatPulseSDK13GroupsRequest")
...
SWIFT_CLASS("_TtCC17CometChatPulseSDK13GroupsRequest20GroupsRequestBuilder")
...
SWIFT_CLASS("_TtC17CometChatPulseSDK12MediaMessage")
...
SWIFT_CLASS("_TtC17CometChatPulseSDK11TextMessage")
...
SWIFT_CLASS("_TtC17CometChatPulseSDK19UserMessagesRequest")
...
SWIFT_CLASS("_TtCC17CometChatPulseSDK19UserMessagesRequest26UserMessagesRequestBuilder")
@interface UserMessagesRequestBuilder : NSObject
- (nonnull instancetype)initFromUID:(NSString * _Nonnull)fromUID timestamp:(NSInteger)timestamp OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initFromUID:(NSString * _Nonnull)fromUID id:(NSInteger)id OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS("_TtC17CometChatPulseSDK12UserPresence")
@interface UserPresence : NSObject
@property (nonatomic) double lastActiveAt;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC17CometChatPulseSDK12UsersRequest")
...
SWIFT_CLASS("_TtCC17CometChatPulseSDK12UsersRequest19UsersRequestBuilder")
