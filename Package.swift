...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "CometChatSDK",
            url: "https://dl.cloudsmith.io/public/cometchat/cometchat/raw/versions/4.1.4/CometChatSDK_4_1_4.xcframework.zip",
            checksum: "ebbb70c6005ed14d722fa57ce34902efce9c99e92f19c6a32af9bb45a018bd07"
        ),
        .binaryTarget(
