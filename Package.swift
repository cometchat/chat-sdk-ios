...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "CometChatSDK",
            url: "https://library.cometchat.io/ios/v4.0/xcode15/CometChatSDK_4_0_55.xcframework.zip",
            checksum: "dc22a5e61c8fdcf4214b6d00747678d8b3cfc17dc48935221751c8b168666f33"
        ),
        .binaryTarget(
