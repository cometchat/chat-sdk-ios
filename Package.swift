...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "CometChatSDK",
            url: "https://library.cometchat.io/ios/v4.0/xcode16/CometChatSDK_4_0_70.xcframework.zip",
            checksum: "5c4ad4f7eac03b43645b5e00a28302bae9a6ea659d0b074502bdf8d0ab72d5e2"
        ),
        .binaryTarget(
