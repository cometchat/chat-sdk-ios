...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "CometChatSDK",
            url: "https://library.cometchat.io/ios/v4.0/xcode16/CometChatSDK_4_0_72.xcframework.zip",
            checksum: "e4fb566d6b147e84e435106fff944c3be5638d027e4692029c84eab34a1253a8"
        ),
        .binaryTarget(
