...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "CometChatSDK",
            url: "https://library.cometchat.io/ios/v4.0/xcode15/CometChatSDK_4_0_41.xcframework.zip",
            checksum: "0bddc6af22755884f363b0c5543e26d51109bf9a9887c401fb7893e7d9c870a2"
        ),
        .binaryTarget(
