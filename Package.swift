...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "CometChatSDK",
            url: "https://library.cometchat.io/ios/v4.0/xcode16/CometChatSDK_4_0_73.xcframework.zip",
            checksum: "3f01754edc49c3c893aa17c3118c17900754fa75f7c973887e3b8b978f8d0fc1"
        ),
        .binaryTarget(
