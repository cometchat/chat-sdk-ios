...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "CometChatSDK",
            url: "https://library.cometchat.io/ios/v4.0/xcode16/CometChatSDK_4_0_60.xcframework.zip",
            checksum: "d64ce9a40d2e50e845750c3cdb8d54bf1a718d2dc85ba65962b8fa54db774578"
        ),
        .binaryTarget(
